    ...
    <div className="min-h-screen bg-background flex items-center justify-center px-6">
      <div className="w-full max-w-sm">
        <div className="text-center mb-8">
          ...
          <p className="text-muted-foreground">Sign in to your second brain</p>
        </div>
        ...
        <form onSubmit={handleLogin} className="space-y-4">
          ...
          <button
            type="submit"
            disabled={loading}
            className="w-full py-2.5 bg-primary text-primary-foreground rounded-lg font-medium hover:opacity-90 transition-opacity disabled:opacity-50 cursor-pointer flex items-center justify-center gap-2"
          >
        ...
        <p className="text-center text-sm text-muted-foreground mt-6">
          ...
          <Link href={`/${lang}/signup`} className="text-accent hover:underline font-medium">
            Sign up
          </Link>
        </p>
      </div>
