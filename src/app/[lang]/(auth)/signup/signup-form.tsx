        ...
        <GlowCard className="w-full max-w-3xl">
          <div className="grid gap-6 p-6 sm:p-8 lg:grid-cols-[0.9fr_1.1fr]">
            <div className="rounded-[1.6rem] bg-[linear-gradient(180deg,#16060f,#3f0b2b_56%,#75004d)] p-6 text-white">
              ...
              <h1 className="font-display mt-8 text-4xl font-bold tracking-[-0.05em]">
        ...
        <GlowCard className="mx-auto w-full max-w-lg">
          <div className="p-6 sm:p-8">
            ...
            <form onSubmit={handleSignup} className="space-y-4">
              ...
              <button
                type="submit"
                className="inline-flex min-h-12 w-full items-center justify-center gap-2 rounded-full bg-[linear-gradient(135deg,#1b0913,#790050_55%,#ff008c)] px-5 py-3 font-semibold text-white shadow-[0_18px_40px_rgba(255,0,140,0.24)]"
              >
                {t("auth.continue")}
            ...
            <p className="mt-7 text-center text-sm text-muted-foreground">
              ...
              <Link href={`/${lang}/login`} className="font-semibold text-accent hover:underline">
                {t("auth.signIn")}
              </Link>
            </p>
          </div>
